...
本记录对应当前发布候选提交 `65eef69`。候选仍处于 Draft PR 阶段，自动化门禁已经通过，跨平台打印、人工安全/隐私/无障碍/运维验收和 72 小时 RC 观察尚未开始，因此本文件当前不是 release tag 或生产部署批准。
...
当前不能代签的原因：本 PR 没有生产镜像 registry digest、release tag、跨平台打印样张、法务批准、人工读屏记录、生产回滚演练或 72 小时生产观察数据。
...
当前决定：**不批准创建 release tag，不批准生产部署**。原因是人工签字、生产 registry digest、回滚演练和 72 小时观察尚未完成；自动化门禁通过不能替代这些发布条件。
...
1. 完成人工排版、安保、隐私/法务、无障碍和运维签字。
2. 创建候选 tag，运行 [release workflow](../.github/workflows/release.yml)，记录 registry image digest、release artifact 和新的 runtime manifest SHA256。
3. 在生产 canary 启动 72 小时观察，记录 P0/P1、P2、稳定性和回滚结果。
4. 由发布负责人更新本文件并明确勾选发布决定。
